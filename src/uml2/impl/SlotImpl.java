 ...
 * <ul>
 *   <li>{@link uml2.impl.SlotImpl#getDefiningFeature <em>Defining Feature</em>}</li>
 *   <li>{@link uml2.impl.SlotImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uml2.impl.SlotImpl#getOwningInstance <em>Owning Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlotImpl extends ElementImpl implements Slot {
	...
	public EList<ValueSpecification> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, Uml2Package.SLOT__VALUE);
		}
		return value;
	}
