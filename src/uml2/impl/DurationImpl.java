 ...
 * <ul>
 *   <li>{@link uml2.impl.DurationImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link uml2.impl.DurationImpl#getObservation <em>Observation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationImpl extends ValueSpecificationImpl implements Duration {
	...
	public NotificationChain basicSetExpr(ValueSpecification newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Uml2Package.DURATION__EXPR, oldExpr, newExpr);
	...
	public void setExpr(ValueSpecification newExpr) {
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Uml2Package.DURATION__EXPR, null, msgs);
			if (newExpr != null)
				msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Uml2Package.DURATION__EXPR, null, msgs);
			msgs = basicSetExpr(newExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2Package.DURATION__EXPR, newExpr, newExpr));
	}
	...
	public EList<Observation> getObservation() {
		if (observation == null) {
			observation = new EObjectResolvingEList<Observation>(Observation.class, this, Uml2Package.DURATION__OBSERVATION);
		}
		return observation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Uml2Package.DURATION__EXPR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Uml2Package.DURATION__EXPR:
				return getExpr();
			case Uml2Package.DURATION__OBSERVATION:
