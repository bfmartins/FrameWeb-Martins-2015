 ...
 * <ul>
 *   <li>{@link uml2.impl.ReceptionImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReceptionImpl extends BehavioralFeatureImpl implements Reception {
	 ...
	 * @generated
	 */
	public boolean notQuery(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.RECEPTION__NOT_QUERY,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "notQuery", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.RECEPTION___NOT_QUERY__DIAGNOSTICCHAIN_MAP:
				return notQuery((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
