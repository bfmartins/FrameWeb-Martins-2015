 ...
 * <ul>
 *   <li>{@link uml2.impl.ReadVariableActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadVariableActionImpl extends VariableActionImpl implements ReadVariableAction {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.READ_VARIABLE_ACTION;
	}
	 ...
	 * @generated
	 */
	public boolean compatibleMultiplicity(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.READ_VARIABLE_ACTION__COMPATIBLE_MULTIPLICITY,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "compatibleMultiplicity", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_VARIABLE_ACTION__TYPE_AND_ORDERING,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.READ_VARIABLE_ACTION___COMPATIBLE_MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
				return compatibleMultiplicity((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_VARIABLE_ACTION___TYPE_AND_ORDERING__DIAGNOSTICCHAIN_MAP:
