 ...
 * <ul>
 *   <li>{@link uml2.impl.ExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link uml2.impl.ExpressionImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionImpl extends ValueSpecificationImpl implements Expression {
	...
	public EList<ValueSpecification> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, Uml2Package.EXPRESSION__OPERAND);
		}
		return operand;
	}
