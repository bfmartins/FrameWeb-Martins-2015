 ...
 * <ul>
 *   <li>{@link uml2.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, Uml2Package.ENUMERATION__OWNED_LITERAL, Uml2Package.ENUMERATION_LITERAL__ENUMERATION);
		}
		return ownedLiteral;
	}
