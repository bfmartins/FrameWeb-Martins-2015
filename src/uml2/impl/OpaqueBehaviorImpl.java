 ...
 * <ul>
 *   <li>{@link uml2.impl.OpaqueBehaviorImpl#getBody <em>Body</em>}</li>
 *   <li>{@link uml2.impl.OpaqueBehaviorImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OpaqueBehaviorImpl extends BehaviorImpl implements OpaqueBehavior {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.OPAQUE_BEHAVIOR;
	}
	...
	public EList<String> getBody() {
		if (body == null) {
			body = new EDataTypeEList<String>(String.class, this, Uml2Package.OPAQUE_BEHAVIOR__BODY);
		}
		return body;
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList<String>(String.class, this, Uml2Package.OPAQUE_BEHAVIOR__LANGUAGE);
		}
		return language;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Uml2Package.OPAQUE_BEHAVIOR__BODY:
				return getBody();
			case Uml2Package.OPAQUE_BEHAVIOR__LANGUAGE:
				return getLanguage();
		}
