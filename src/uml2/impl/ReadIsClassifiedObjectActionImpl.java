 ...
 * <ul>
 *   <li>{@link uml2.impl.ReadIsClassifiedObjectActionImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link uml2.impl.ReadIsClassifiedObjectActionImpl#getIsDirect <em>Is Direct</em>}</li>
 *   <li>{@link uml2.impl.ReadIsClassifiedObjectActionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link uml2.impl.ReadIsClassifiedObjectActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadIsClassifiedObjectActionImpl extends ActionImpl implements ReadIsClassifiedObjectAction {
	 ...
	 * @ordered
	 */
	protected static final Boolean IS_DIRECT_EDEFAULT = Boolean.FALSE;
	 ...
	 * @generated
	 */
	public boolean booleanResult(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.READ_IS_CLASSIFIED_OBJECT_ACTION__BOOLEAN_RESULT,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "booleanResult", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public boolean multiplicityOfInput(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_IS_CLASSIFIED_OBJECT_ACTION__MULTIPLICITY_OF_INPUT,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "multiplicityOfInput", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_IS_CLASSIFIED_OBJECT_ACTION__NO_TYPE,
	 ...
	 * @generated
	 */
	public boolean multiplicityOfOutput(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_IS_CLASSIFIED_OBJECT_ACTION__MULTIPLICITY_OF_OUTPUT,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "multiplicityOfOutput", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.READ_IS_CLASSIFIED_OBJECT_ACTION___BOOLEAN_RESULT__DIAGNOSTICCHAIN_MAP:
				return booleanResult((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_IS_CLASSIFIED_OBJECT_ACTION___MULTIPLICITY_OF_INPUT__DIAGNOSTICCHAIN_MAP:
				return multiplicityOfInput((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_IS_CLASSIFIED_OBJECT_ACTION___NO_TYPE__DIAGNOSTICCHAIN_MAP:
				return noType((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_IS_CLASSIFIED_OBJECT_ACTION___MULTIPLICITY_OF_OUTPUT__DIAGNOSTICCHAIN_MAP:
				return multiplicityOfOutput((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
