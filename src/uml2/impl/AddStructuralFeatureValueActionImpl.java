 ...
 * <ul>
 *   <li>{@link uml2.impl.AddStructuralFeatureValueActionImpl#getInsertAt <em>Insert At</em>}</li>
 *   <li>{@link uml2.impl.AddStructuralFeatureValueActionImpl#getIsReplaceAll <em>Is Replace All</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddStructuralFeatureValueActionImpl extends WriteStructuralFeatureActionImpl implements AddStructuralFeatureValueAction {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__REQUIRED_VALUE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__UNLIMITED_NATURAL_AND_MULTIPLICITY,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.ADD_STRUCTURAL_FEATURE_VALUE_ACTION___REQUIRED_VALUE__DIAGNOSTICCHAIN_MAP:
				return requiredValue((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.ADD_STRUCTURAL_FEATURE_VALUE_ACTION___UNLIMITED_NATURAL_AND_MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
