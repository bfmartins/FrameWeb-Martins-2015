 ...
 * <ul>
 *   <li>{@link uml2.impl.ExtensionPointImpl#getUseCase <em>Use Case</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionPointImpl extends RedefinableElementImpl implements ExtensionPoint {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.EXTENSION_POINT__MUST_HAVE_NAME,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.EXTENSION_POINT___MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP:
