 ...
 * <ul>
 *   <li>{@link uml2.impl.OpaqueActionImpl#getBody <em>Body</em>}</li>
 *   <li>{@link uml2.impl.OpaqueActionImpl#getInputValue <em>Input Value</em>}</li>
 *   <li>{@link uml2.impl.OpaqueActionImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link uml2.impl.OpaqueActionImpl#getOutputValue <em>Output Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OpaqueActionImpl extends ActionImpl implements OpaqueAction {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.OPAQUE_ACTION;
	}
	...
	public EList<String> getBody() {
		if (body == null) {
			body = new EDataTypeEList<String>(String.class, this, Uml2Package.OPAQUE_ACTION__BODY);
		}
		return body;
	}
	...
	public EList<InputPin> getInputValue() {
		if (inputValue == null) {
			inputValue = new EObjectContainmentEList<InputPin>(InputPin.class, this, Uml2Package.OPAQUE_ACTION__INPUT_VALUE);
		}
		return inputValue;
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList<String>(String.class, this, Uml2Package.OPAQUE_ACTION__LANGUAGE);
		}
		return language;
	}
	...
	public EList<OutputPin> getOutputValue() {
		if (outputValue == null) {
			outputValue = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, Uml2Package.OPAQUE_ACTION__OUTPUT_VALUE);
		}
		return outputValue;
	}
