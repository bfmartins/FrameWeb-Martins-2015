 ...
 * <ul>
 *   <li>{@link uml2.impl.ValuePinImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValuePinImpl extends InputPinImpl implements ValuePin {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.VALUE_PIN;
	}
	 ...
	 * @generated
	 */
	public boolean noIncomingEdges(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.VALUE_PIN__NO_INCOMING_EDGES,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "noIncomingEdges", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.VALUE_PIN__COMPATIBLE_TYPE,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.VALUE_PIN___NO_INCOMING_EDGES__DIAGNOSTICCHAIN_MAP:
				return noIncomingEdges((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.VALUE_PIN___COMPATIBLE_TYPE__DIAGNOSTICCHAIN_MAP:
