 ...
 * <ul>
 *   <li>{@link uml2.impl.CreateLinkObjectActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CreateLinkObjectActionImpl extends CreateLinkActionImpl implements CreateLinkObjectAction {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.CREATE_LINK_OBJECT_ACTION__TYPE_OF_RESULT,
	 ...
	 * @generated
	 */
	public boolean associationClass(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.CREATE_LINK_OBJECT_ACTION__ASSOCIATION_CLASS,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "associationClass", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.CREATE_LINK_OBJECT_ACTION__MULTIPLICITY,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.CREATE_LINK_OBJECT_ACTION___TYPE_OF_RESULT__DIAGNOSTICCHAIN_MAP:
				return typeOfResult((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.CREATE_LINK_OBJECT_ACTION___ASSOCIATION_CLASS__DIAGNOSTICCHAIN_MAP:
				return associationClass((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.CREATE_LINK_OBJECT_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
