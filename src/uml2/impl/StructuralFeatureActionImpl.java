 ...
 * <ul>
 *   <li>{@link uml2.impl.StructuralFeatureActionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link uml2.impl.StructuralFeatureActionImpl#getStructuralFeature <em>Structural Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuralFeatureActionImpl extends ActionImpl implements StructuralFeatureAction {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.STRUCTURAL_FEATURE_ACTION;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.STRUCTURAL_FEATURE_ACTION__VISIBILITY,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.STRUCTURAL_FEATURE_ACTION__MULTIPLICITY,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.STRUCTURAL_FEATURE_ACTION__NOT_STATIC,
	 ...
	 * @generated
	 */
	public boolean oneFeaturingClassifier(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.STRUCTURAL_FEATURE_ACTION__ONE_FEATURING_CLASSIFIER,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "oneFeaturingClassifier", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.STRUCTURAL_FEATURE_ACTION__SAME_TYPE,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.STRUCTURAL_FEATURE_ACTION___VISIBILITY__DIAGNOSTICCHAIN_MAP:
				return visibility((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.STRUCTURAL_FEATURE_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
				return multiplicity((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.STRUCTURAL_FEATURE_ACTION___NOT_STATIC__DIAGNOSTICCHAIN_MAP:
				return notStatic((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.STRUCTURAL_FEATURE_ACTION___ONE_FEATURING_CLASSIFIER__DIAGNOSTICCHAIN_MAP:
				return oneFeaturingClassifier((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.STRUCTURAL_FEATURE_ACTION___SAME_TYPE__DIAGNOSTICCHAIN_MAP:
