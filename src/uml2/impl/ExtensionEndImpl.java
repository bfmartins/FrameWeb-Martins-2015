...
public class ExtensionEndImpl extends PropertyImpl implements ExtensionEnd {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.EXTENSION_END__MULTIPLICITY,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.EXTENSION_END__AGGREGATION,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.EXTENSION_END___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
				return multiplicity((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.EXTENSION_END___AGGREGATION__DIAGNOSTICCHAIN_MAP:
				return aggregation((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
