...
public class ActorImpl extends BehavioredClassifierImpl implements Actor {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.ACTOR;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.ACTOR__ASSOCIATIONS,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.ACTOR__MUST_HAVE_NAME,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.ACTOR___ASSOCIATIONS__DIAGNOSTICCHAIN_MAP:
				return associations((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.ACTOR___MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP:
