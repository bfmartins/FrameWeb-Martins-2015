 ...
 * <ul>
 *   <li>{@link uml2.impl.SendSignalActionImpl#getSignal <em>Signal</em>}</li>
 *   <li>{@link uml2.impl.SendSignalActionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SendSignalActionImpl extends InvocationActionImpl implements SendSignalAction {
	 ...
	 * @generated
	 */
	public boolean numberOrder(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.SEND_SIGNAL_ACTION__NUMBER_ORDER,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "numberOrder", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.SEND_SIGNAL_ACTION__TYPE_ORDERING_MULTIPLICITY,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.SEND_SIGNAL_ACTION___NUMBER_ORDER__DIAGNOSTICCHAIN_MAP:
				return numberOrder((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.SEND_SIGNAL_ACTION___TYPE_ORDERING_MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
