 ...
 * <ul>
 *   <li>{@link uml2.impl.RemoveStructuralFeatureValueActionImpl#getIsRemoveDuplicates <em>Is Remove Duplicates</em>}</li>
 *   <li>{@link uml2.impl.RemoveStructuralFeatureValueActionImpl#getRemoveAt <em>Remove At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveStructuralFeatureValueActionImpl extends WriteStructuralFeatureActionImpl implements RemoveStructuralFeatureValueAction {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION;
	}
	...
	public void setIsRemoveDuplicates(Boolean newIsRemoveDuplicates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2Package.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__IS_REMOVE_DUPLICATES, oldIsRemoveDuplicates, isRemoveDuplicates));
	}
	...
	public NotificationChain basicSetRemoveAt(InputPin newRemoveAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Uml2Package.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__REMOVE_AT, oldRemoveAt, newRemoveAt);
	...
	public void setRemoveAt(InputPin newRemoveAt) {
		if (newRemoveAt != removeAt) {
			...
			if (removeAt != null)
				msgs = ((InternalEObject)removeAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Uml2Package.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__REMOVE_AT, null, msgs);
			if (newRemoveAt != null)
				msgs = ((InternalEObject)newRemoveAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Uml2Package.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__REMOVE_AT, null, msgs);
			msgs = basicSetRemoveAt(newRemoveAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2Package.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__REMOVE_AT, newRemoveAt, newRemoveAt));
	}
	 ...
	 * @generated
	 */
	public boolean nonUniqueRemoval(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION__NON_UNIQUE_REMOVAL,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "nonUniqueRemoval", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION___NON_UNIQUE_REMOVAL__DIAGNOSTICCHAIN_MAP:
				return nonUniqueRemoval((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
