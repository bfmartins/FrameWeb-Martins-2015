 ...
 * <ul>
 *   <li>{@link uml2.ReadStructuralFeatureAction#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getReadStructuralFeatureAction()
 * @model
 * @generated
 */
public interface ReadStructuralFeatureAction extends StructuralFeatureAction {
	 ...
	 * @see uml2.Uml2Package#getReadStructuralFeatureAction_Result()
	...
	/**
	 * Sets the value of the '{@link uml2.ReadStructuralFeatureAction#getResult <em>Result</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.result.type = self.structuralFeature.type\nand self.result.ordering = self.structuralFeature.ordering\n'"
	 * @generated
	 */
