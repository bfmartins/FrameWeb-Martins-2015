 ...
 *
 *
 * @see uml2.Uml2Package#getExtensionEnd()
 * @model
 * @generated
 */
public interface ExtensionEnd extends Property {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='(self->lowerBound() = 0 or self->lowerBound() = 1) and self->upperBound() = 1'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.aggregation = #composite'"
	 * @generated
	 */
