	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Uml2Package.PACKAGE: {
				uml2.Package package_ = (uml2.Package)theEObject;
			...
			case Uml2Package.CLASS: {
				uml2.Class class_ = (uml2.Class)theEObject;
			...
			case Uml2Package.DESTRUCTION_OCCURENCE_SPECIFICATION: {
				...
				if (result == null) result = caseMessageOccurrenceSpecification(destructionOccurenceSpecification);
				if (result == null) result = caseOccurrenceSpecification(destructionOccurenceSpecification);
				if (result == null) result = caseMessageEnd(destructionOccurenceSpecification);
