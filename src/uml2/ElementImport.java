 ...
 * <ul>
 *   <li>{@link uml2.ElementImport#getAlias <em>Alias</em>}</li>
 *   <li>{@link uml2.ElementImport#getImportedElement <em>Imported Element</em>}</li>
 *   <li>{@link uml2.ElementImport#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link uml2.ElementImport#getImportingNamespace <em>Importing Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getElementImport()
 * @model
 * @generated
 */
public interface ElementImport extends DirectedRelationship {
	 ...
	 * @see #setAlias(String)
	 * @see uml2.Uml2Package#getElementImport_Alias()
	...
	/**
	 * Sets the value of the '{@link uml2.ElementImport#getAlias <em>Alias</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uml2.Uml2Package#getElementImport_ImportedElement()
	...
	/**
	 * Sets the value of the '{@link uml2.ElementImport#getImportedElement <em>Imported Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uml2.Uml2Package#getElementImport_Visibility()
	...
	/**
	 * Sets the value of the '{@link uml2.ElementImport#getVisibility <em>Visibility</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link uml2.Namespace#getElementImport <em>Element Import</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uml2.Uml2Package#getElementImport_ImportingNamespace()
	...
	/**
	 * Sets the value of the '{@link uml2.ElementImport#getImportingNamespace <em>Importing Namespace</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	boolean visibilityPublicOrPrivate(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.importedElement.visibility.notEmpty() implies self.importedElement.visibility = #public'"
	 * @generated
	 */
	boolean importedElementIsPublic(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * endif
	 * <!-- end-model-doc -->
	 * @model kind="operation" dataType="primitiveTypes.String" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='result = if self.alias->notEmpty() then\n  self.alias\nelse\n  self.importedElement.name\nendif'"
	 * @generated
	 */
	String getName();
