 ...
 * <ul>
 *   <li>{@link uml2.CreateLinkObjectAction#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getCreateLinkObjectAction()
 * @model
 * @generated
 */
public interface CreateLinkObjectAction extends CreateLinkAction {
	 ...
	 * @see uml2.Uml2Package#getCreateLinkObjectAction_Result()
	...
	/**
	 * Sets the value of the '{@link uml2.CreateLinkObjectAction#getResult <em>Result</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.result.type = self.association()'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.association().oclIsKindOf(Class)'"
	 * @generated
	 */
	boolean associationClass(DiagnosticChain diagnostics, Map<Object, Object> context);
