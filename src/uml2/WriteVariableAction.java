 ...
 * <ul>
 *   <li>{@link uml2.WriteVariableAction#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getWriteVariableAction()
 * @model abstract="true"
 * @generated
 */
public interface WriteVariableAction extends VariableAction {
	 ...
	 * @see uml2.Uml2Package#getWriteVariableAction_Value()
	...
	/**
	 * Sets the value of the '{@link uml2.WriteVariableAction#getValue <em>Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.value -> notEmpty() implies self.value.type = self.variable.type'"
	 * @generated
	 */
