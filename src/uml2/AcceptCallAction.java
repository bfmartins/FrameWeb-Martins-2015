 ...
 * <ul>
 *   <li>{@link uml2.AcceptCallAction#getReturnInformation <em>Return Information</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getAcceptCallAction()
 * @model
 * @generated
 */
public interface AcceptCallAction extends AcceptEventAction {
	 ...
	 * @see uml2.Uml2Package#getAcceptCallAction_ReturnInformation()
	...
	/**
	 * Sets the value of the '{@link uml2.AcceptCallAction#getReturnInformation <em>Return Information</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='trigger.event.oclIsKindOf(CallEvent)'"
	 * @generated
	 */
	boolean triggerCallEvent(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='isUnmarshall = true'"
	 * @generated
	 */
