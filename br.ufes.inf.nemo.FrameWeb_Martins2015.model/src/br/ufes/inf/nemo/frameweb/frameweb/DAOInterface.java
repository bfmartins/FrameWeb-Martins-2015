 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.DAOInterface#getDAOInterfaceName <em>DAO Interface Name</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.DAOInterface#getInfix <em>Infix</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.DAOInterface#getSufix <em>Sufix</em>}</li>
 * </ul>
 * </p>
 *
 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getDAOInterface()
 * @model
 * @generated
 */
public interface DAOInterface extends Interface {
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getDAOInterface_DAOInterfaceName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.DAOInterface#getDAOInterfaceName <em>DAO Interface Name</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setInfix(String)
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getDAOInterface_Infix()
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.DAOInterface#getInfix <em>Infix</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getDAOInterface_Sufix()
