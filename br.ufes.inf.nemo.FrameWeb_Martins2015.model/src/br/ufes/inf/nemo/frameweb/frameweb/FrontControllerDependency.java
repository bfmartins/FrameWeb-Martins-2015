 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.FrontControllerDependency#getMethod <em>Method</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.FrontControllerDependency#getMethodDependendencyConstraint <em>Method Dependendency Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getFrontControllerDependency()
...
public interface FrontControllerDependency extends NavigationDependency {
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getFrontControllerDependency_Method()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.FrontControllerDependency#getMethod <em>Method</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getFrontControllerDependency_MethodDependendencyConstraint()
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.FrontControllerDependency#getMethodDependendencyConstraint <em>Method Dependendency Constraint</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
