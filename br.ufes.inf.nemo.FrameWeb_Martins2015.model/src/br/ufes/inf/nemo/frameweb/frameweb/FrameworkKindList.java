 ...
 * <!-- end-user-doc -->
 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getFrameworkKindList()
 * @model
 * @generated
 */
public enum FrameworkKindList implements Enumerator {
	 ...
	 * @generated
	 */
	private static final FrameworkKindList[] VALUES_ARRAY =
		new FrameworkKindList[] {
	...
	public static FrameworkKindList get(int value) {
		switch (value) {
			case STANDARD_SPECIFICATION_VALUE: return STANDARD_SPECIFICATION;
			case FRAMEWORK_SPECIFICATION_VALUE: return FRAMEWORK_SPECIFICATION;
			case FRAMEWORK_IMPLEMENTATION_VALUE: return FRAMEWORK_IMPLEMENTATION;
