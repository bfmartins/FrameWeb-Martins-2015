 ...
 * <!-- end-user-doc -->
 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getOrder()
 * @model
 * @generated
 */
public enum Order implements Enumerator {
	...
	public static Order get(int value) {
		switch (value) {
			...
			case COLUMN_NAME_ASC_VALUE: return COLUMN_NAME_ASC;
			case COLUMN_NAME_DESC_VALUE: return COLUMN_NAME_DESC;
		}
		return null;
	}
