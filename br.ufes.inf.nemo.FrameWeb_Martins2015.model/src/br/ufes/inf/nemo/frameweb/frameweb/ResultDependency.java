 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getResultResult <em>Result Result</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getResultMethod <em>Result Method</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getResultDependendencyCosntraint <em>Result Dependendency Cosntraint</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getRender <em>Render</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getExecute <em>Execute</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#isAjax <em>Ajax</em>}</li>
 * </ul>
 * </p>
 *
 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency()
...
public interface ResultDependency extends NavigationDependency {
	 ...
	 * The list contents are of type {@link br.ufes.inf.nemo.frameweb.frameweb.Result}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency_ResultResult()
	 * @model
	 * @generated
	 */
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency_ResultMethod()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getResultMethod <em>Result Method</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency_ResultDependendencyCosntraint()
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getResultDependendencyCosntraint <em>Result Dependendency Cosntraint</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency_Render()
	 * @model default="@none"
	 * @generated
	 */
	String getRender();
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getRender <em>Render</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency_Execute()
	 * @model default="@this"
	 * @generated
	 */
	String getExecute();
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#getExecute <em>Execute</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAjax(boolean)
	 * @see br.ufes.inf.nemo.frameweb.frameweb.FramewebPackage#getResultDependency_Ajax()
	 * @model default="False"
	 * @generated
	 */
	boolean isAjax();
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.frameweb.frameweb.ResultDependency#isAjax <em>Ajax</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
