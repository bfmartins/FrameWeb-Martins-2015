 ...
 *   <li>{@link frameweb.impl.DataPropertyImpl#isIsDerived <em>Is Derived</em>}</li>
...
public class DataPropertyImpl extends VocabularyEntityImpl implements DataProperty {
	...
	public void setIsDerived(boolean newIsDerived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.DATA_PROPERTY__IS_DERIVED, oldIsDerived, isDerived));
	}
	...
	public EList<Property> getMemberEnd() {
		if (memberEnd == null) {
			memberEnd = new EObjectWithInverseResolvingEList<Property>(Property.class, this, FramewebPackage.DATA_PROPERTY__MEMBER_END, FramewebPackage.PROPERTY__ASSOCIATION);
		}
		return memberEnd;
	}
	...
	public EList<Property> getOwnedEnd() {
		if (ownedEnd == null) {
			ownedEnd = new EObjectContainmentWithInverseEList<Property>(Property.class, this, FramewebPackage.DATA_PROPERTY__OWNED_END, FramewebPackage.PROPERTY__OWNING_ASSOCIATION);
		}
		return ownedEnd;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (derivedFeatureID) {
				case FramewebPackage.DATA_PROPERTY__RELATED_ELEMENT: return UMLPackage.RELATIONSHIP__RELATED_ELEMENT;
				default: return -1;
			}
		}
		if (baseClass == Association.class) {
			switch (derivedFeatureID) {
				case FramewebPackage.DATA_PROPERTY__END_TYPE: return FramewebPackage.ASSOCIATION__END_TYPE;
				case FramewebPackage.DATA_PROPERTY__IS_DERIVED: return FramewebPackage.ASSOCIATION__IS_DERIVED;
				case FramewebPackage.DATA_PROPERTY__MEMBER_END: return FramewebPackage.ASSOCIATION__MEMBER_END;
				case FramewebPackage.DATA_PROPERTY__OWNED_END: return FramewebPackage.ASSOCIATION__OWNED_END;
				case FramewebPackage.DATA_PROPERTY__NAVIGABLE_OWNED_END: return FramewebPackage.ASSOCIATION__NAVIGABLE_OWNED_END;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (baseFeatureID) {
				case UMLPackage.RELATIONSHIP__RELATED_ELEMENT: return FramewebPackage.DATA_PROPERTY__RELATED_ELEMENT;
				default: return -1;
			}
		}
		if (baseClass == Association.class) {
			switch (baseFeatureID) {
				case FramewebPackage.ASSOCIATION__END_TYPE: return FramewebPackage.DATA_PROPERTY__END_TYPE;
				case FramewebPackage.ASSOCIATION__IS_DERIVED: return FramewebPackage.DATA_PROPERTY__IS_DERIVED;
				case FramewebPackage.ASSOCIATION__MEMBER_END: return FramewebPackage.DATA_PROPERTY__MEMBER_END;
				case FramewebPackage.ASSOCIATION__OWNED_END: return FramewebPackage.DATA_PROPERTY__OWNED_END;
				case FramewebPackage.ASSOCIATION__NAVIGABLE_OWNED_END: return FramewebPackage.DATA_PROPERTY__NAVIGABLE_OWNED_END;
				default: return -1;
			}
		}
		if (baseClass == VocabularyAssociation.class) {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == Association.class) {
			switch (baseOperationID) {
				case FramewebPackage.ASSOCIATION___SPECIALIZED_END_NUMBER__DIAGNOSTICCHAIN_MAP: return FramewebPackage.DATA_PROPERTY___SPECIALIZED_END_NUMBER__DIAGNOSTICCHAIN_MAP;
				case FramewebPackage.ASSOCIATION___SPECIALIZED_END_TYPES__DIAGNOSTICCHAIN_MAP: return FramewebPackage.DATA_PROPERTY___SPECIALIZED_END_TYPES__DIAGNOSTICCHAIN_MAP;
				case FramewebPackage.ASSOCIATION___BINARY_ASSOCIATIONS__DIAGNOSTICCHAIN_MAP: return FramewebPackage.DATA_PROPERTY___BINARY_ASSOCIATIONS__DIAGNOSTICCHAIN_MAP;
				case FramewebPackage.ASSOCIATION___ASSOCIATION_ENDS__DIAGNOSTICCHAIN_MAP: return FramewebPackage.DATA_PROPERTY___ASSOCIATION_ENDS__DIAGNOSTICCHAIN_MAP;
				case FramewebPackage.ASSOCIATION___ENDS_MUST_BE_TYPED__DIAGNOSTICCHAIN_MAP: return FramewebPackage.DATA_PROPERTY___ENDS_MUST_BE_TYPED__DIAGNOSTICCHAIN_MAP;
				case FramewebPackage.ASSOCIATION___IS_BINARY: return FramewebPackage.DATA_PROPERTY___IS_BINARY;
				case FramewebPackage.ASSOCIATION___GET_END_TYPES: return FramewebPackage.DATA_PROPERTY___GET_END_TYPES;
				default: return -1;
			}
		}
		if (baseClass == VocabularyAssociation.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case FramewebPackage.DATA_PROPERTY___SPECIALIZED_END_NUMBER__DIAGNOSTICCHAIN_MAP:
				return specialized_end_number((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.DATA_PROPERTY___SPECIALIZED_END_TYPES__DIAGNOSTICCHAIN_MAP:
				return specialized_end_types((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.DATA_PROPERTY___BINARY_ASSOCIATIONS__DIAGNOSTICCHAIN_MAP:
				return binary_associations((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.DATA_PROPERTY___ASSOCIATION_ENDS__DIAGNOSTICCHAIN_MAP:
				return association_ends((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.DATA_PROPERTY___ENDS_MUST_BE_TYPED__DIAGNOSTICCHAIN_MAP:
			...
			case FramewebPackage.DATA_PROPERTY___IS_BINARY:
				return isBinary();
			case FramewebPackage.DATA_PROPERTY___GET_END_TYPES:
				return getEndTypes();
		}
