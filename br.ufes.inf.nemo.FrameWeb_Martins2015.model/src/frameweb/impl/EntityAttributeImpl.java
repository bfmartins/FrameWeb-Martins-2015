 ...
 * <ul>
 *   <li>{@link frameweb.impl.EntityAttributeImpl#getSize <em>Size</em>}</li>
 *   <li>{@link frameweb.impl.EntityAttributeImpl#isIsNull <em>Is Null</em>}</li>
 *   <li>{@link frameweb.impl.EntityAttributeImpl#isIsPersistent <em>Is Persistent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class EntityAttributeImpl extends PropertyImpl implements EntityAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return FramewebPackage.Literals.ENTITY_ATTRIBUTE;
	}
	...
	public void setSize(long newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ATTRIBUTE__SIZE, oldSize, size));
	}
	...
	public void setIsNull(boolean newIsNull) {
		...
		isNull = newIsNull;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ATTRIBUTE__IS_NULL, oldIsNull, isNull));
	}
	...
	public void setIsPersistent(boolean newIsPersistent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ATTRIBUTE__IS_PERSISTENT, oldIsPersistent, isPersistent));
	}
