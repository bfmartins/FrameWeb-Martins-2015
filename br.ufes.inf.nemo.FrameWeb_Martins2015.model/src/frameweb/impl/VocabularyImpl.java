 ...
 *   <li>{@link frameweb.impl.VocabularyImpl#getAxioms <em>Axioms</em>}</li>
...
public class VocabularyImpl extends PackageImpl implements Vocabulary {
	...
	public EList<IRI> getDirectlyImportsDocuments() {
		if (directlyImportsDocuments == null) {
			directlyImportsDocuments = new EObjectContainmentEList<IRI>(IRI.class, this, FramewebPackage.VOCABULARY__DIRECTLY_IMPORTS_DOCUMENTS);
		}
		...
		if (vocabularyIRI != null && vocabularyIRI.eIsProxy()) {
			...
			if (vocabularyIRI != oldVocabularyIRI) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FramewebPackage.VOCABULARY__VOCABULARY_IRI, oldVocabularyIRI, vocabularyIRI));
			}
		}
	...
	public void setVocabularyIRI(IRI newVocabularyIRI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.VOCABULARY__VOCABULARY_IRI, oldVocabularyIRI, vocabularyIRI));
	}
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, FramewebPackage.VOCABULARY__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public void setVocabularyDocument(String newVocabularyDocument) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.VOCABULARY__VOCABULARY_DOCUMENT, oldVocabularyDocument, vocabularyDocument));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FramewebPackage.VOCABULARY__VOCABULARY_IRI:
				if (resolve) return getVocabularyIRI();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FramewebPackage.VOCABULARY__VOCABULARY_DOCUMENT:
				return VOCABULARY_DOCUMENT_EDEFAULT == null ? vocabularyDocument != null : !VOCABULARY_DOCUMENT_EDEFAULT.equals(vocabularyDocument);
		}
