 ...
 *   <li>{@link frameweb.impl.AssociationImpl#isIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link frameweb.impl.AssociationImpl#getMemberEnd <em>Member End</em>}</li>
...
public class AssociationImpl extends ClassifierImpl implements Association {
	...
	protected EClass eStaticClass() {
		return FramewebPackage.Literals.ASSOCIATION;
	}
	...
	public void setIsDerived(boolean newIsDerived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ASSOCIATION__IS_DERIVED, oldIsDerived, isDerived));
	}
	...
	public EList<Property> getMemberEnd() {
		if (memberEnd == null) {
			memberEnd = new EObjectWithInverseResolvingEList<Property>(Property.class, this, FramewebPackage.ASSOCIATION__MEMBER_END, FramewebPackage.PROPERTY__ASSOCIATION);
		}
		return memberEnd;
	}
	...
	public EList<Property> getOwnedEnd() {
		if (ownedEnd == null) {
			ownedEnd = new EObjectContainmentWithInverseEList<Property>(Property.class, this, FramewebPackage.ASSOCIATION__OWNED_END, FramewebPackage.PROPERTY__OWNING_ASSOCIATION);
		}
		return ownedEnd;
	}
	...
	public EList<Property> getNavigableOwnedEnd() {
		if (navigableOwnedEnd == null) {
			navigableOwnedEnd = new EObjectResolvingEList<Property>(Property.class, this, FramewebPackage.ASSOCIATION__NAVIGABLE_OWNED_END);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FramewebPackage.ASSOCIATION__MEMBER_END:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FramewebPackage.ASSOCIATION__RELATED_ELEMENT:
				return getRelatedElements();
			case FramewebPackage.ASSOCIATION__END_TYPE:
				return getEndType();
			...
			case FramewebPackage.ASSOCIATION__OWNED_END:
				return getOwnedEnd();
			case FramewebPackage.ASSOCIATION__NAVIGABLE_OWNED_END:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (derivedFeatureID) {
				case FramewebPackage.ASSOCIATION__RELATED_ELEMENT: return UMLPackage.RELATIONSHIP__RELATED_ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (baseFeatureID) {
				case UMLPackage.RELATIONSHIP__RELATED_ELEMENT: return FramewebPackage.ASSOCIATION__RELATED_ELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case FramewebPackage.ASSOCIATION___SPECIALIZED_END_NUMBER__DIAGNOSTICCHAIN_MAP:
				return specialized_end_number((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.ASSOCIATION___SPECIALIZED_END_TYPES__DIAGNOSTICCHAIN_MAP:
				return specialized_end_types((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.ASSOCIATION___BINARY_ASSOCIATIONS__DIAGNOSTICCHAIN_MAP:
				return binary_associations((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.ASSOCIATION___ASSOCIATION_ENDS__DIAGNOSTICCHAIN_MAP:
				return association_ends((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.ASSOCIATION___ENDS_MUST_BE_TYPED__DIAGNOSTICCHAIN_MAP:
				return ends_must_be_typed((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case FramewebPackage.ASSOCIATION___IS_BINARY:
				return isBinary();
			case FramewebPackage.ASSOCIATION___GET_END_TYPES:
				return getEndTypes();
		}
