...
public class VocabularyDataTypeImpl extends VocabularyEntityImpl implements VocabularyDataType {
	...
	public EList<Property> getOwnedAttributes() {
		if (ownedAttributes == null) {
			ownedAttributes = new EObjectContainmentWithInverseEList.Resolving<Property>(Property.class, this, FramewebPackage.VOCABULARY_DATA_TYPE__OWNED_ATTRIBUTE, UMLPackage.PROPERTY__DATATYPE);
		}
	...
	public EList<Operation> getOwnedOperations() {
		if (ownedOperations == null) {
			ownedOperations = new EObjectContainmentWithInverseEList.Resolving<Operation>(Operation.class, this, FramewebPackage.VOCABULARY_DATA_TYPE__OWNED_OPERATION, UMLPackage.OPERATION__DATATYPE);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DataType.class) {
			switch (derivedFeatureID) {
				case FramewebPackage.VOCABULARY_DATA_TYPE__OWNED_ATTRIBUTE: return UMLPackage.DATA_TYPE__OWNED_ATTRIBUTE;
				case FramewebPackage.VOCABULARY_DATA_TYPE__OWNED_OPERATION: return UMLPackage.DATA_TYPE__OWNED_OPERATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DataType.class) {
			switch (baseFeatureID) {
				case UMLPackage.DATA_TYPE__OWNED_ATTRIBUTE: return FramewebPackage.VOCABULARY_DATA_TYPE__OWNED_ATTRIBUTE;
				case UMLPackage.DATA_TYPE__OWNED_OPERATION: return FramewebPackage.VOCABULARY_DATA_TYPE__OWNED_OPERATION;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == DataType.class) {
			switch (baseOperationID) {
				case UMLPackage.DATA_TYPE___CREATE_OWNED_ATTRIBUTE__STRING_TYPE_INT_INT: return FramewebPackage.VOCABULARY_DATA_TYPE___CREATE_OWNED_ATTRIBUTE__STRING_TYPE_INT_INT;
				case UMLPackage.DATA_TYPE___CREATE_OWNED_OPERATION__STRING_ELIST_ELIST_TYPE: return FramewebPackage.VOCABULARY_DATA_TYPE___CREATE_OWNED_OPERATION__STRING_ELIST_ELIST_TYPE;
				default: return -1;
			}
		}
