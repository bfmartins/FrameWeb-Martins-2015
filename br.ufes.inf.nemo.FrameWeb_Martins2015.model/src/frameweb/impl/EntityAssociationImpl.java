 ...
 * <ul>
 *   <li>{@link frameweb.impl.EntityAssociationImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link frameweb.impl.EntityAssociationImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link frameweb.impl.EntityAssociationImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link frameweb.impl.EntityAssociationImpl#getOrder <em>Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntityAssociationImpl extends AssociationImpl implements EntityAssociation {
	/**
	...
	protected EClass eStaticClass() {
		return FramewebPackage.Literals.ENTITY_ASSOCIATION;
	}
	...
	public void setCollection(Collection newCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ASSOCIATION__COLLECTION, oldCollection, collection));
	}
	...
	public void setCascade(Cascade newCascade) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ASSOCIATION__CASCADE, oldCascade, cascade));
	}
	...
	public void setFetch(Fetch newFetch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ASSOCIATION__FETCH, oldFetch, fetch));
	}
	...
	public void setOrder(Order newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.ENTITY_ASSOCIATION__ORDER, oldOrder, order));
	}
