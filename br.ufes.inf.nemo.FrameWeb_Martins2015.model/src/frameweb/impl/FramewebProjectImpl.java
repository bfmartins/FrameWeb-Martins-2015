...
public class FramewebProjectImpl extends MinimalEObjectImpl.Container implements FramewebProject {
	...
	public EList<FramewebModel> getCompose() {
		if (compose == null) {
			compose = new EObjectContainmentEList<FramewebModel>(FramewebModel.class, this, FramewebPackage.FRAMEWEB_PROJECT__COMPOSE);
		}
		return compose;
	}
	...
	public EList<FrameworkProfile> getConfigures() {
		if (configures == null) {
			configures = new EObjectContainmentEList<FrameworkProfile>(FrameworkProfile.class, this, FramewebPackage.FRAMEWEB_PROJECT__CONFIGURES);
		}
		return configures;
	}
