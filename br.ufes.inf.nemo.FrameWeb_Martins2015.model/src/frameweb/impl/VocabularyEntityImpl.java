 ...
 * <ul>
 *   <li>{@link frameweb.impl.VocabularyEntityImpl#getEntityIRI <em>Entity IRI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VocabularyEntityImpl extends ClassifierImpl implements VocabularyEntity {
		...
		if (entityIRI != null && entityIRI.eIsProxy()) {
			...
			if (entityIRI != oldEntityIRI) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FramewebPackage.VOCABULARY_ENTITY__ENTITY_IRI, oldEntityIRI, entityIRI));
			}
		}
		return entityIRI;
	}
	...
	public void setEntityIRI(IRI newEntityIRI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FramewebPackage.VOCABULARY_ENTITY__ENTITY_IRI, oldEntityIRI, entityIRI));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FramewebPackage.VOCABULARY_ENTITY__ENTITY_IRI:
				if (resolve) return getEntityIRI();
