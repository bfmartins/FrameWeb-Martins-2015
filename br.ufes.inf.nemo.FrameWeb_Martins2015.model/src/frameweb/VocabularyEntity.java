...
public interface VocabularyEntity extends Classifier {
	 ...
	 * @see frameweb.FramewebPackage#getVocabularyEntity_EntityIRI()
	 * @model required="true"
	 * @generated
	 */
	IRI getEntityIRI();
	...
	/**
	 * Sets the value of the '{@link frameweb.VocabularyEntity#getEntityIRI <em>Entity IRI</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
