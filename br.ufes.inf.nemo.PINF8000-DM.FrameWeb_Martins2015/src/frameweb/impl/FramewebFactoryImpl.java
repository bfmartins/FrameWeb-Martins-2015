...
public class FramewebFactoryImpl extends EFactoryImpl implements FramewebFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FramewebPackage.FRAMEWEB: return (EObject)createFrameweb();
			...
			case FramewebPackage.DAO_BASE_OPERATION: return (EObject)createDAOBaseOperation();
			...
			case FramewebPackage.CONSTANT_NAME: return (EObject)createConstantName();
			case FramewebPackage.DOMAIN_TABLE_NAME: return (EObject)createDomainTableName();
			case FramewebPackage.FRAME_WORK_NAME: return (EObject)createFrameWorkName();
			case FramewebPackage.DOMAIN_COLUMN_NAME: return (EObject)createDomainColumnName();
			case FramewebPackage.DAO_INTERFACE_NAME: return (EObject)createDAOInterfaceName();
			case FramewebPackage.DAO_CLASS_NAME: return (EObject)createDAOClassName();
			...
			case FramewebPackage.RESULT_TYPE: return (EObject)createResultType();
			...
			case FramewebPackage.RULE: return (EObject)createRule();
			case FramewebPackage.ANOTATION: return (EObject)createAnotation();
			default:
