 ...
 * <ul>
 *   <li>{@link uml2.Behavior#getContext <em>Context</em>}</li>
 *   <li>{@link uml2.Behavior#getIsReentrant <em>Is Reentrant</em>}</li>
 *   <li>{@link uml2.Behavior#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link uml2.Behavior#getOwnedParameterSet <em>Owned Parameter Set</em>}</li>
 *   <li>{@link uml2.Behavior#getPostcondition <em>Postcondition</em>}</li>
 *   <li>{@link uml2.Behavior#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link uml2.Behavior#getRedefinedBehavior <em>Redefined Behavior</em>}</li>
 *   <li>{@link uml2.Behavior#getSpecification <em>Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getBehavior()
 * @model abstract="true"
 * @generated
 */
public interface Behavior extends uml2.Class {
	/**
	 ...
	 * @see uml2.Uml2Package#getBehavior_Context()
	 ...
	 * @see uml2.Uml2Package#getBehavior_IsReentrant()
	...
	/**
	 * Sets the value of the '{@link uml2.Behavior#getIsReentrant <em>Is Reentrant</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uml2.Uml2Package#getBehavior_OwnedParameter()
	 ...
	 * @see uml2.Uml2Package#getBehavior_OwnedParameterSet()
	 ...
	 * @see uml2.Uml2Package#getBehavior_Postcondition()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see uml2.Uml2Package#getBehavior_Precondition()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see uml2.Uml2Package#getBehavior_RedefinedBehavior()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link uml2.BehavioralFeature#getMethod <em>Method</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uml2.Uml2Package#getBehavior_Specification()
	...
	/**
	 * Sets the value of the '{@link uml2.Behavior#getSpecification <em>Specification</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	boolean mustRealize(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean parametersMatch(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean featureOfContextClassifier(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean mostOneBehaviour(DiagnosticChain diagnostics, Map<Object, Object> context);
