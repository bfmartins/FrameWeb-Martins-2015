 ...
 * <ul>
 *   <li>{@link uml2.Dependency#getClient <em>Client</em>}</li>
 *   <li>{@link uml2.Dependency#getSupplier <em>Supplier</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getDependency()
 * @model
 * @generated
 */
public interface Dependency extends PackageableElement, DirectedRelationship {
	 ...
	 * It is bidirectional and its opposite is '{@link uml2.NamedElement#getClientDependency <em>Client Dependency</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uml2.Uml2Package#getDependency_Client()
	 ...
	 * @see uml2.Uml2Package#getDependency_Supplier()
