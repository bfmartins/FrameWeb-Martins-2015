 ...
 * <ul>
 *   <li>{@link uml2.impl.DeploymentImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link uml2.impl.DeploymentImpl#getDeployedArtifact <em>Deployed Artifact</em>}</li>
 *   <li>{@link uml2.impl.DeploymentImpl#getLocation <em>Location</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeploymentImpl extends DependencyImpl implements Deployment {
	...
	public EList<DeploymentSpecification> getConfiguration() {
		if (configuration == null) {
			configuration = new EObjectContainmentWithInverseEList<DeploymentSpecification>(DeploymentSpecification.class, this, Uml2Package.DEPLOYMENT__CONFIGURATION, Uml2Package.DEPLOYMENT_SPECIFICATION__DEPLOYMENT);
		}
