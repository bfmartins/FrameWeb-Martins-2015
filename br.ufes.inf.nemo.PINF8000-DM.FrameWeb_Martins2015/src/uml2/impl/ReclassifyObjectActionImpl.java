 ...
 * <ul>
 *   <li>{@link uml2.impl.ReclassifyObjectActionImpl#getIsReplaceAll <em>Is Replace All</em>}</li>
 *   <li>{@link uml2.impl.ReclassifyObjectActionImpl#getNewClassifier <em>New Classifier</em>}</li>
 *   <li>{@link uml2.impl.ReclassifyObjectActionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link uml2.impl.ReclassifyObjectActionImpl#getOldClassifier <em>Old Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReclassifyObjectActionImpl extends ActionImpl implements ReclassifyObjectAction {
	...
	public EList<Classifier> getNewClassifier() {
		if (newClassifier == null) {
			newClassifier = new EObjectResolvingEList<Classifier>(Classifier.class, this, Uml2Package.RECLASSIFY_OBJECT_ACTION__NEW_CLASSIFIER);
		}
	...
	public EList<Classifier> getOldClassifier() {
		if (oldClassifier == null) {
			oldClassifier = new EObjectResolvingEList<Classifier>(Classifier.class, this, Uml2Package.RECLASSIFY_OBJECT_ACTION__OLD_CLASSIFIER);
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.RECLASSIFY_OBJECT_ACTION__INPUT_PIN,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.RECLASSIFY_OBJECT_ACTION__MULTIPLICITY,
	 ...
	 * @generated
	 */
	public boolean classifierNotAbstract(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.RECLASSIFY_OBJECT_ACTION__CLASSIFIER_NOT_ABSTRACT,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "classifierNotAbstract", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.RECLASSIFY_OBJECT_ACTION___INPUT_PIN__DIAGNOSTICCHAIN_MAP:
				return inputPin((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.RECLASSIFY_OBJECT_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
				return multiplicity((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.RECLASSIFY_OBJECT_ACTION___CLASSIFIER_NOT_ABSTRACT__DIAGNOSTICCHAIN_MAP:
				return classifierNotAbstract((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
