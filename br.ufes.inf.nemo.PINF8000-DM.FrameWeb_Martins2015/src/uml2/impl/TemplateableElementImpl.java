 ...
 * <ul>
 *   <li>{@link uml2.impl.TemplateableElementImpl#getTemplateBinding <em>Template Binding</em>}</li>
 *   <li>{@link uml2.impl.TemplateableElementImpl#getOwnedTemplateSignature <em>Owned Template Signature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TemplateableElementImpl extends ElementImpl implements TemplateableElement {
	...
	public EList<TemplateBinding> getTemplateBinding() {
		if (templateBinding == null) {
			templateBinding = new EObjectContainmentWithInverseEList<TemplateBinding>(TemplateBinding.class, this, Uml2Package.TEMPLATEABLE_ELEMENT__TEMPLATE_BINDING, Uml2Package.TEMPLATE_BINDING__BOUND_ELEMENT);
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.TEMPLATEABLE_ELEMENT___IS_TEMPLATE:
				return isTemplate();
			case Uml2Package.TEMPLATEABLE_ELEMENT___PARAMETERABLE_ELEMENTS:
