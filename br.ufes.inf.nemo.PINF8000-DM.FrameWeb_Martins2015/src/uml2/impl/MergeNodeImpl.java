...
public class MergeNodeImpl extends ControlNodeImpl implements MergeNode {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.MERGE_NODE;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.MERGE_NODE__EDGES,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.MERGE_NODE__ONE_OUTGOING_EDGE,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.MERGE_NODE___EDGES__DIAGNOSTICCHAIN_MAP:
				return edges((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.MERGE_NODE___ONE_OUTGOING_EDGE__DIAGNOSTICCHAIN_MAP:
