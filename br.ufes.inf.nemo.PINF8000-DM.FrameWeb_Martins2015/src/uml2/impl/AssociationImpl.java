 ...
 * <ul>
 *   <li>{@link uml2.impl.AssociationImpl#getRelatedElement <em>Related Element</em>}</li>
 *   <li>{@link uml2.impl.AssociationImpl#getEndType <em>End Type</em>}</li>
 *   <li>{@link uml2.impl.AssociationImpl#getIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link uml2.impl.AssociationImpl#getNavigableOwnedEnd <em>Navigable Owned End</em>}</li>
 *   <li>{@link uml2.impl.AssociationImpl#getOwnedEnd <em>Owned End</em>}</li>
 *   <li>{@link uml2.impl.AssociationImpl#getMemberEnd <em>Member End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssociationImpl extends ClassifierImpl implements Association {
	...
	public EList<Property> getNavigableOwnedEnd() {
		if (navigableOwnedEnd == null) {
			navigableOwnedEnd = new EObjectResolvingEList<Property>(Property.class, this, Uml2Package.ASSOCIATION__NAVIGABLE_OWNED_END);
		}
	...
	public EList<Property> getOwnedEnd() {
		if (ownedEnd == null) {
			ownedEnd = new EObjectContainmentWithInverseEList<Property>(Property.class, this, Uml2Package.ASSOCIATION__OWNED_END, Uml2Package.PROPERTY__OWNING_ASSOCIATION);
		}
		return ownedEnd;
	}
	...
	public EList<Property> getMemberEnd() {
		if (memberEnd == null) {
			memberEnd = new EObjectWithInverseResolvingEList<Property>(Property.class, this, Uml2Package.ASSOCIATION__MEMBER_END, Uml2Package.PROPERTY__ASSOCIATION);
		}
		return memberEnd;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Uml2Package.ASSOCIATION__IS_DERIVED:
				return getIsDerived();
			case Uml2Package.ASSOCIATION__NAVIGABLE_OWNED_END:
