 ...
 * <ul>
 *   <li>{@link uml2.impl.InteractionFragmentImpl#getCovered <em>Covered</em>}</li>
 *   <li>{@link uml2.impl.InteractionFragmentImpl#getEnclosingInteraction <em>Enclosing Interaction</em>}</li>
 *   <li>{@link uml2.impl.InteractionFragmentImpl#getEnclosingOperand <em>Enclosing Operand</em>}</li>
 *   <li>{@link uml2.impl.InteractionFragmentImpl#getGeneralOrdering <em>General Ordering</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InteractionFragmentImpl extends NamedElementImpl implements InteractionFragment {
	...
	public EList<Lifeline> getCovered() {
		if (covered == null) {
			covered = new EObjectWithInverseResolvingEList.ManyInverse<Lifeline>(Lifeline.class, this, Uml2Package.INTERACTION_FRAGMENT__COVERED, Uml2Package.LIFELINE__COVERED_BY);
		}
		return covered;
	}
	...
	public EList<GeneralOrdering> getGeneralOrdering() {
		if (generalOrdering == null) {
			generalOrdering = new EObjectContainmentEList<GeneralOrdering>(GeneralOrdering.class, this, Uml2Package.INTERACTION_FRAGMENT__GENERAL_ORDERING);
		}
