 ...
 * <ul>
 *   <li>{@link uml2.impl.ExecutionOccurrenceSpecificationImpl#getExecution <em>Execution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionOccurrenceSpecificationImpl extends OccurrenceSpecificationImpl implements ExecutionOccurrenceSpecification {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.EXECUTION_OCCURRENCE_SPECIFICATION;
	}
		...
		if (execution != null && execution.eIsProxy()) {
			...
			if (execution != oldExecution) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Uml2Package.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION, oldExecution, execution));
			}
		}
		return execution;
	}
	...
	public void setExecution(ExecutionSpecification newExecution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2Package.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION, oldExecution, execution));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Uml2Package.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION:
