 ...
 * <ul>
 *   <li>{@link uml2.impl.ClearAssociationActionImpl#getAssociation <em>Association</em>}</li>
 *   <li>{@link uml2.impl.ClearAssociationActionImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClearAssociationActionImpl extends ActionImpl implements ClearAssociationAction {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.CLEAR_ASSOCIATION_ACTION__SAME_TYPE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.CLEAR_ASSOCIATION_ACTION__MULTIPLICITY,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.CLEAR_ASSOCIATION_ACTION___SAME_TYPE__DIAGNOSTICCHAIN_MAP:
				return sameType((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.CLEAR_ASSOCIATION_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
