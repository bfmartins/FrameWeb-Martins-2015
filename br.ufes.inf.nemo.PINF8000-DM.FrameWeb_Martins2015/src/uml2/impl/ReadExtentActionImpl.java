 ...
 * <ul>
 *   <li>{@link uml2.impl.ReadExtentActionImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link uml2.impl.ReadExtentActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadExtentActionImpl extends ActionImpl implements ReadExtentAction {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.READ_EXTENT_ACTION;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.READ_EXTENT_ACTION__MULTIPLICITY_OF_RESULT,
	 ...
	 * @generated
	 */
	public boolean typeIsClassifier(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_EXTENT_ACTION__TYPE_IS_CLASSIFIER,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "typeIsClassifier", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.READ_EXTENT_ACTION___MULTIPLICITY_OF_RESULT__DIAGNOSTICCHAIN_MAP:
				return multiplicityOfResult((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_EXTENT_ACTION___TYPE_IS_CLASSIFIER__DIAGNOSTICCHAIN_MAP:
				return typeIsClassifier((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
