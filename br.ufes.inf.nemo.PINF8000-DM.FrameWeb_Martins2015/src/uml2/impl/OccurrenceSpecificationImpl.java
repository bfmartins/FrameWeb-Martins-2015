 ...
 * <ul>
 *   <li>{@link uml2.impl.OccurrenceSpecificationImpl#getToAfter <em>To After</em>}</li>
 *   <li>{@link uml2.impl.OccurrenceSpecificationImpl#getToBefore <em>To Before</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OccurrenceSpecificationImpl extends InteractionFragmentImpl implements OccurrenceSpecification {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.OCCURRENCE_SPECIFICATION;
	}
	...
	public EList<GeneralOrdering> getToAfter() {
		if (toAfter == null) {
			toAfter = new EObjectWithInverseResolvingEList<GeneralOrdering>(GeneralOrdering.class, this, Uml2Package.OCCURRENCE_SPECIFICATION__TO_AFTER, Uml2Package.GENERAL_ORDERING__BEFORE);
		}
		return toAfter;
	}
	...
	public EList<GeneralOrdering> getToBefore() {
		if (toBefore == null) {
			toBefore = new EObjectWithInverseResolvingEList<GeneralOrdering>(GeneralOrdering.class, this, Uml2Package.OCCURRENCE_SPECIFICATION__TO_BEFORE, Uml2Package.GENERAL_ORDERING__AFTER);
		}
		return toBefore;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Uml2Package.OCCURRENCE_SPECIFICATION__TO_AFTER:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getToAfter()).basicAdd(otherEnd, msgs);
			case Uml2Package.OCCURRENCE_SPECIFICATION__TO_BEFORE:
