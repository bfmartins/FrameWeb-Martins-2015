 ...
 * <ul>
 *   <li>{@link uml2.impl.CollaborationImpl#getClassifierBehavior <em>Classifier Behavior</em>}</li>
 *   <li>{@link uml2.impl.CollaborationImpl#getInterfaceRealization <em>Interface Realization</em>}</li>
 *   <li>{@link uml2.impl.CollaborationImpl#getOwnedBehavior <em>Owned Behavior</em>}</li>
 *   <li>{@link uml2.impl.CollaborationImpl#getCollaborationRole <em>Collaboration Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollaborationImpl extends StructuredClassifierImpl implements Collaboration {
		...
		if (classifierBehavior != null && classifierBehavior.eIsProxy()) {
			...
			if (classifierBehavior != oldClassifierBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Uml2Package.COLLABORATION__CLASSIFIER_BEHAVIOR, oldClassifierBehavior, classifierBehavior));
			}
		}
	...
	public void setClassifierBehavior(Behavior newClassifierBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2Package.COLLABORATION__CLASSIFIER_BEHAVIOR, oldClassifierBehavior, classifierBehavior));
	}
	...
	public EList<InterfaceRealization> getInterfaceRealization() {
		if (interfaceRealization == null) {
			interfaceRealization = new EObjectContainmentWithInverseEList<InterfaceRealization>(InterfaceRealization.class, this, Uml2Package.COLLABORATION__INTERFACE_REALIZATION, Uml2Package.INTERFACE_REALIZATION__IMPLEMENTING_CLASSIFIER);
		}
	...
	public EList<Behavior> getOwnedBehavior() {
		if (ownedBehavior == null) {
			ownedBehavior = new EObjectContainmentEList<Behavior>(Behavior.class, this, Uml2Package.COLLABORATION__OWNED_BEHAVIOR);
		}
	...
	public EList<ConnectableElement> getCollaborationRole() {
		if (collaborationRole == null) {
			collaborationRole = new EObjectResolvingEList<ConnectableElement>(ConnectableElement.class, this, Uml2Package.COLLABORATION__COLLABORATION_ROLE);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BehavioredClassifier.class) {
			switch (derivedFeatureID) {
				case Uml2Package.COLLABORATION__CLASSIFIER_BEHAVIOR: return Uml2Package.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR;
				case Uml2Package.COLLABORATION__INTERFACE_REALIZATION: return Uml2Package.BEHAVIORED_CLASSIFIER__INTERFACE_REALIZATION;
				case Uml2Package.COLLABORATION__OWNED_BEHAVIOR: return Uml2Package.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BehavioredClassifier.class) {
			switch (baseFeatureID) {
				case Uml2Package.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR: return Uml2Package.COLLABORATION__CLASSIFIER_BEHAVIOR;
				case Uml2Package.BEHAVIORED_CLASSIFIER__INTERFACE_REALIZATION: return Uml2Package.COLLABORATION__INTERFACE_REALIZATION;
				case Uml2Package.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR: return Uml2Package.COLLABORATION__OWNED_BEHAVIOR;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == BehavioredClassifier.class) {
			switch (baseOperationID) {
				case Uml2Package.BEHAVIORED_CLASSIFIER___CLASS_BEHAVIOR__DIAGNOSTICCHAIN_MAP: return Uml2Package.COLLABORATION___CLASS_BEHAVIOR__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.COLLABORATION___CLASS_BEHAVIOR__DIAGNOSTICCHAIN_MAP:
