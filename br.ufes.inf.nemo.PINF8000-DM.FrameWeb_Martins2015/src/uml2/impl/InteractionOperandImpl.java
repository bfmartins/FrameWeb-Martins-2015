 ...
 * <ul>
 *   <li>{@link uml2.impl.InteractionOperandImpl#getCovered <em>Covered</em>}</li>
 *   <li>{@link uml2.impl.InteractionOperandImpl#getEnclosingInteraction <em>Enclosing Interaction</em>}</li>
 *   <li>{@link uml2.impl.InteractionOperandImpl#getEnclosingOperand <em>Enclosing Operand</em>}</li>
 *   <li>{@link uml2.impl.InteractionOperandImpl#getGeneralOrdering <em>General Ordering</em>}</li>
 *   <li>{@link uml2.impl.InteractionOperandImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link uml2.impl.InteractionOperandImpl#getFragment <em>Fragment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InteractionOperandImpl extends NamespaceImpl implements InteractionOperand {
	 ...
	 * @generated
	 */
	public boolean guardContainReferences(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.INTERACTION_OPERAND__GUARD_CONTAIN_REFERENCES,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "guardContainReferences", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public boolean guardDirectlyPrior(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.INTERACTION_OPERAND__GUARD_DIRECTLY_PRIOR,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "guardDirectlyPrior", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.INTERACTION_OPERAND___GUARD_CONTAIN_REFERENCES__DIAGNOSTICCHAIN_MAP:
				return guardContainReferences((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.INTERACTION_OPERAND___GUARD_DIRECTLY_PRIOR__DIAGNOSTICCHAIN_MAP:
				return guardDirectlyPrior((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
