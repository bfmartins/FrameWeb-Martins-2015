 ...
 * <ul>
 *   <li>{@link uml2.impl.PackageableElementImpl#getOwningTemplateParameter <em>Owning Template Parameter</em>}</li>
 *   <li>{@link uml2.impl.PackageableElementImpl#getTemplateParameter <em>Template Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PackageableElementImpl extends NamedElementImpl implements PackageableElement {
	...
	public TemplateParameter getOwningTemplateParameter() {
		if (eContainerFeatureID() != Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER) return null;
	...
	public NotificationChain basicSetOwningTemplateParameter(TemplateParameter newOwningTemplateParameter, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningTemplateParameter, Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER, msgs);
		return msgs;
	}
	...
	public void setOwningTemplateParameter(TemplateParameter newOwningTemplateParameter) {
		if (newOwningTemplateParameter != eInternalContainer() || (eContainerFeatureID() != Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER && newOwningTemplateParameter != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER, newOwningTemplateParameter, newOwningTemplateParameter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ParameterableElement.class) {
			switch (derivedFeatureID) {
				case Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER: return Uml2Package.PARAMETERABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ParameterableElement.class) {
			switch (baseFeatureID) {
				case Uml2Package.PARAMETERABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER: return Uml2Package.PACKAGEABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER;
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ParameterableElement.class) {
			switch (baseOperationID) {
				case Uml2Package.PARAMETERABLE_ELEMENT___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT: return Uml2Package.PACKAGEABLE_ELEMENT___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT;
				case Uml2Package.PARAMETERABLE_ELEMENT___IS_TEMPLATE_PARAMETER: return Uml2Package.PACKAGEABLE_ELEMENT___IS_TEMPLATE_PARAMETER;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.PACKAGEABLE_ELEMENT___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT:
				return isCompatibleWith((ParameterableElement)arguments.get(0));
			case Uml2Package.PACKAGEABLE_ELEMENT___IS_TEMPLATE_PARAMETER:
