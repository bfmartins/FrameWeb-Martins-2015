 ...
 * <ul>
 *   <li>{@link uml2.impl.VertexImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link uml2.impl.VertexImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link uml2.impl.VertexImpl#getIncoming <em>Incoming</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VertexImpl extends NamedElementImpl implements Vertex {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.VERTEX___CONTAINING_STATE_MACHINE:
				return containingStateMachine();
			case Uml2Package.VERTEX___INCOMING:
				return incoming();
			case Uml2Package.VERTEX___OUTGOING:
				return outgoing();
		}
