 ...
 * <ul>
 *   <li>{@link uml2.impl.StructuredClassifierImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 *   <li>{@link uml2.impl.StructuredClassifierImpl#getOwnedConnector <em>Owned Connector</em>}</li>
 *   <li>{@link uml2.impl.StructuredClassifierImpl#getPart <em>Part</em>}</li>
 *   <li>{@link uml2.impl.StructuredClassifierImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuredClassifierImpl extends ClassifierImpl implements StructuredClassifier {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.STRUCTURED_CLASSIFIER__MULTIPLICITIES,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.STRUCTURED_CLASSIFIER___MULTIPLICITIES__DIAGNOSTICCHAIN_MAP:
				return multiplicities((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.STRUCTURED_CLASSIFIER___PART:
				return part();
		}
