 ...
 * <ul>
 *   <li>{@link uml2.impl.ReadSelfActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadSelfActionImpl extends ActionImpl implements ReadSelfAction {
	...
	protected EClass eStaticClass() {
		return Uml2Package.Literals.READ_SELF_ACTION;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.READ_SELF_ACTION__MULTIPLICITY,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_SELF_ACTION__NOT_STATIC,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_SELF_ACTION__TYPE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.READ_SELF_ACTION__CONTAINED,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.READ_SELF_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
				return multiplicity((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_SELF_ACTION___NOT_STATIC__DIAGNOSTICCHAIN_MAP:
				return notStatic((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_SELF_ACTION___TYPE__DIAGNOSTICCHAIN_MAP:
				return type((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.READ_SELF_ACTION___CONTAINED__DIAGNOSTICCHAIN_MAP:
				return contained((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
