 ...
 * <ul>
 *   <li>{@link uml2.impl.CombinedFragmentImpl#getCfragmentGate <em>Cfragment Gate</em>}</li>
 *   <li>{@link uml2.impl.CombinedFragmentImpl#getInteractionOperator <em>Interaction Operator</em>}</li>
 *   <li>{@link uml2.impl.CombinedFragmentImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CombinedFragmentImpl extends InteractionFragmentImpl implements CombinedFragment {
	...
	public EList<Gate> getCfragmentGate() {
		if (cfragmentGate == null) {
			cfragmentGate = new EObjectContainmentEList<Gate>(Gate.class, this, Uml2Package.COMBINED_FRAGMENT__CFRAGMENT_GATE);
		}
	...
	public EList<InteractionOperand> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<InteractionOperand>(InteractionOperand.class, this, Uml2Package.COMBINED_FRAGMENT__OPERAND);
		}
		return operand;
	}
	 ...
	 * @generated
	 */
	public boolean minintAndMaxint(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Uml2Validator.COMBINED_FRAGMENT__MININT_AND_MAXINT,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "minintAndMaxint", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public boolean optLoopBreakNeg(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.COMBINED_FRAGMENT__OPT_LOOP_BREAK_NEG,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "optLoopBreakNeg", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.COMBINED_FRAGMENT__BREAK_,
	 ...
	 * @generated
	 */
	public boolean considerAndIgnore(DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO: implement this method
		// -> specify the condition that violates the invariant
		// -> verify the details of the diagnostic, including severity and message
		// Ensure that you remove @generated or mark it @generated NOT
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Uml2Validator.DIAGNOSTIC_SOURCE,
						 Uml2Validator.COMBINED_FRAGMENT__CONSIDER_AND_IGNORE,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "considerAndIgnore", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Uml2Package.COMBINED_FRAGMENT___MININT_AND_MAXINT__DIAGNOSTICCHAIN_MAP:
				return minintAndMaxint((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.COMBINED_FRAGMENT___OPT_LOOP_BREAK_NEG__DIAGNOSTICCHAIN_MAP:
				return optLoopBreakNeg((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.COMBINED_FRAGMENT___BREAK____DIAGNOSTICCHAIN_MAP:
				return break_((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Uml2Package.COMBINED_FRAGMENT___CONSIDER_AND_IGNORE__DIAGNOSTICCHAIN_MAP:
				return considerAndIgnore((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
