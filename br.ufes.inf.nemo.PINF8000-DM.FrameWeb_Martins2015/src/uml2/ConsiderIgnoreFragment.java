 ...
 * <ul>
 *   <li>{@link uml2.ConsiderIgnoreFragment#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getConsiderIgnoreFragment()
 * @model
 * @generated
 */
public interface ConsiderIgnoreFragment extends CombinedFragment {
	 ...
	 * @see uml2.Uml2Package#getConsiderIgnoreFragment_Message()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='(interactionOperator = #consider) or (interactionOperator = #ignore)'"
	 * @generated
	 */
	boolean considerOrIgnore(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='message->forAll(m | m.oclIsKindOf(Operation) or m.oclIsKindOf(Reception) or m.oclIsKindOf(Signal))'"
	 * @generated
	 */
