 ...
 * <ul>
 *   <li>{@link uml2.InstanceSpecification#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link uml2.InstanceSpecification#getSlot <em>Slot</em>}</li>
 *   <li>{@link uml2.InstanceSpecification#getSpecification <em>Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getInstanceSpecification()
 * @model
 * @generated
 */
public interface InstanceSpecification extends DeploymentTarget, PackageableElement, DeployedArtifact {
	 ...
	 * @see uml2.Uml2Package#getInstanceSpecification_Classifier()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link uml2.Slot}.
	 * It is bidirectional and its opposite is '{@link uml2.Slot#getOwningInstance <em>Owning Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uml2.Uml2Package#getInstanceSpecification_Slot()
	 ...
	 * @see uml2.Uml2Package#getInstanceSpecification_Specification()
	...
	/**
	 * Sets the value of the '{@link uml2.InstanceSpecification#getSpecification <em>Specification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='classifier->forAll(c | (c.allFeatures()->forAll(f | slot->select(s | s.definingFeature = f)->size() <= 1)))'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='slot->forAll(s | classifier->exists (c | c.allFeatures()->includes (s.definingFeature)))'"
	 * @generated
	 */
	boolean definingFeature(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean deploymentArtifact(DiagnosticChain diagnostics, Map<Object, Object> context);
