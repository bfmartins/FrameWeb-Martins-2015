 ...
 * <ul>
 *   <li>{@link uml2.QualifierValue#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link uml2.QualifierValue#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getQualifierValue()
 * @model
 * @generated
 */
public interface QualifierValue extends Element {
	 ...
	 * @see uml2.Uml2Package#getQualifierValue_Qualifier()
	...
	/**
	 * Sets the value of the '{@link uml2.QualifierValue#getQualifier <em>Qualifier</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uml2.Uml2Package#getQualifierValue_Value()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	InputPin getValue();
	...
	/**
	 * Sets the value of the '{@link uml2.QualifierValue#getValue <em>Value</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.value.type = self.qualifier.type'"
	 * @generated
	 */
	boolean typeOfQualifier(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.LinkEndData.end->collect(qualifier)->includes(self.qualifier)'"
	 * @generated
	 */
