 ...
 * <ul>
 *   <li>{@link uml2.Trigger#getEvent <em>Event</em>}</li>
 *   <li>{@link uml2.Trigger#getPort <em>Port</em>}</li>
 * </ul>
 * </p>
 *
 * @see uml2.Uml2Package#getTrigger()
 * @model
 * @generated
 */
public interface Trigger extends NamedElement {
	 ...
	 * @see #setEvent(Event)
	 * @see uml2.Uml2Package#getTrigger_Event()
	...
	/**
	 * Sets the value of the '{@link uml2.Trigger#getEvent <em>Event</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uml2.Uml2Package#getTrigger_Port()
	 * @model ordered="false"
	 * @generated
	 */
	EList<Port> getPort();
