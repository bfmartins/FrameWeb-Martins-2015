...
/**
 * This is the item provider adapter for a {@link frameweb.IdAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdAttributeItemProvider extends DomainAttributeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IdAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IdAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((IdAttribute)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IdAttribute_type") :
			getString("_UI_IdAttribute_type") + " " + label;
	}
