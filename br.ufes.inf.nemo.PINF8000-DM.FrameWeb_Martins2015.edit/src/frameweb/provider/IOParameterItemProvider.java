 ...
 * @generated
 */
public class IOParameterItemProvider extends NavigationAttributeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IOParameterItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IOParameter"));
	}
	...
	public String getText(Object object) {
		String label = ((IOParameter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IOParameter_type") :
			getString("_UI_IOParameter_type") + " " + label;
	}
