 ...
 * @generated
 */
public class DomainGeneralizationItemProvider extends uml.provider.GeneralizationItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return getString("_UI_DomainGeneralization_type") + " " + domainGeneralization.isIsSubstitutable();
	}
