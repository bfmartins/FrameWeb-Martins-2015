...
/**
 * This is the item provider adapter for a {@link frameweb.ConstantName} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstantNameItemProvider extends FrameWebNameItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConstantNameItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConstantName"));
	}
	...
	public String getText(Object object) {
		ConstantNameList labelValue = ((ConstantName)object).getFwName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ConstantName_type") :
			getString("_UI_ConstantName_type") + " " + label;
	}
