...
/**
 * This is the item provider adapter for a {@link frameweb.MappedClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappedClassItemProvider extends DomainClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MappedClassItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MappedClass"));
	}
	...
	public String getText(Object object) {
		String label = ((MappedClass)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MappedClass_type") :
			getString("_UI_MappedClass_type") + " " + label;
	}
