...
/**
 * This is the item provider adapter for a {@link uml.ReadLinkObjectEndQualifierAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReadLinkObjectEndQualifierActionItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReadLinkObjectEndQualifierAction_qualifier_feature", "_UI_ReadLinkObjectEndQualifierAction_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.Literals.READ_LINK_OBJECT_END_QUALIFIER_ACTION__OBJECT);
			childrenFeatures.add(UmlPackage.Literals.READ_LINK_OBJECT_END_QUALIFIER_ACTION__RESULT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReadLinkObjectEndQualifierAction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ReadLinkObjectEndQualifierAction_type") :
			getString("_UI_ReadLinkObjectEndQualifierAction_type") + " " + label;
	}
