...
/**
 * This is the item provider adapter for a {@link uml.ReadIsClassifiedObjectAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReadIsClassifiedObjectActionItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReadIsClassifiedObjectAction_classifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReadIsClassifiedObjectAction_classifier_feature", "_UI_ReadIsClassifiedObjectAction_type"),
	...
	protected void addIsDirectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReadIsClassifiedObjectAction_isDirect_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReadIsClassifiedObjectAction_isDirect_feature", "_UI_ReadIsClassifiedObjectAction_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.Literals.READ_IS_CLASSIFIED_OBJECT_ACTION__OBJECT);
			childrenFeatures.add(UmlPackage.Literals.READ_IS_CLASSIFIED_OBJECT_ACTION__RESULT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReadIsClassifiedObjectAction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ReadIsClassifiedObjectAction_type") :
			getString("_UI_ReadIsClassifiedObjectAction_type") + " " + label;
	}
