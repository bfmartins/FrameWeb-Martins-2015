...
/**
 * This is the item provider adapter for a {@link ecore.EEnumLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EEnumLiteralItemProvider extends ENamedElementItemProvider {
	...
	public String getText(Object object) {
		String label = ((EEnumLiteral)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EEnumLiteral_type") :
			getString("_UI_EEnumLiteral_type") + " " + label;
	}
