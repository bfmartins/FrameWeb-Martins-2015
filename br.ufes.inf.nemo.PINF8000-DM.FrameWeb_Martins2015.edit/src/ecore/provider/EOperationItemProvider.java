...
/**
 * This is the item provider adapter for a {@link ecore.EOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EOperationItemProvider extends ETypedElementItemProvider {
	...
	public String getText(Object object) {
		String label = ((EOperation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EOperation_type") :
			getString("_UI_EOperation_type") + " " + label;
	}
