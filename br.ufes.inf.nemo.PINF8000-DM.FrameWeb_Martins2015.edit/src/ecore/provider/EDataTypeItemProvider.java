...
/**
 * This is the item provider adapter for a {@link ecore.EDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EDataTypeItemProvider extends EClassifierItemProvider {
	...
	public String getText(Object object) {
		String label = ((EDataType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EDataType_type") :
			getString("_UI_EDataType_type") + " " + label;
	}
