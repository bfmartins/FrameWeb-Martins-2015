...
/**
 * This is the item provider adapter for a {@link uml2.WriteVariableAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WriteVariableActionItemProvider extends VariableActionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2Package.Literals.WRITE_VARIABLE_ACTION__VALUE);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_WriteVariableAction_type") :
			getString("_UI_WriteVariableAction_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2Package.Literals.WRITE_VARIABLE_ACTION__VALUE,
