...
/**
 * This is the item provider adapter for a {@link uml2.ProfileApplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileApplicationItemProvider extends DirectedRelationshipItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProfileApplication_appliedProfile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileApplication_appliedProfile_feature", "_UI_ProfileApplication_type"),
				 Uml2Package.Literals.PROFILE_APPLICATION__APPLIED_PROFILE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.PROFILE_APPLICATION__IS_STRICT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Boolean labelValue = ((ProfileApplication)object).getIsStrict();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ProfileApplication_type") :
			getString("_UI_ProfileApplication_type") + " " + label;
	}
