...
/**
 * This is the item provider adapter for a {@link uml2.LinkEndDestructionData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkEndDestructionDataItemProvider extends LinkEndDataItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.LINK_END_DESTRUCTION_DATA__DESTROY_AT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.LINK_END_DESTRUCTION_DATA__IS_DESTROY_DUPLICATES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Boolean labelValue = ((LinkEndDestructionData)object).getIsDestroyDuplicates();
