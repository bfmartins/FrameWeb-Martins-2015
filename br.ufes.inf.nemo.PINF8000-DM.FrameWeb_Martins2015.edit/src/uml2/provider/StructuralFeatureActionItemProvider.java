...
/**
 * This is the item provider adapter for a {@link uml2.StructuralFeatureAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructuralFeatureActionItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StructuralFeatureAction_structuralFeature_feature", "_UI_StructuralFeatureAction_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_StructuralFeatureAction_type") :
			getString("_UI_StructuralFeatureAction_type") + " " + label;
	}
