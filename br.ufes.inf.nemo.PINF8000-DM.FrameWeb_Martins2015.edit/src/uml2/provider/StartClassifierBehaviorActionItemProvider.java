...
/**
 * This is the item provider adapter for a {@link uml2.StartClassifierBehaviorAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartClassifierBehaviorActionItemProvider extends ActionItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2Package.Literals.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT);
		}
	...
	public String getText(Object object) {
		String label = ((StartClassifierBehaviorAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StartClassifierBehaviorAction_type") :
			getString("_UI_StartClassifierBehaviorAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StartClassifierBehaviorAction.class)) {
			case Uml2Package.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2Package.Literals.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT,
