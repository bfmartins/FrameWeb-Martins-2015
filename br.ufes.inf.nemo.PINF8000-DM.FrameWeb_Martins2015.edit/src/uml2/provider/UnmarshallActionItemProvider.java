...
/**
 * This is the item provider adapter for a {@link uml2.UnmarshallAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnmarshallActionItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnmarshallAction_unmarshallType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnmarshallAction_unmarshallType_feature", "_UI_UnmarshallAction_type"),
				 Uml2Package.Literals.UNMARSHALL_ACTION__UNMARSHALL_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2Package.Literals.UNMARSHALL_ACTION__OBJECT);
			childrenFeatures.add(Uml2Package.Literals.UNMARSHALL_ACTION__RESULT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnmarshallAction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UnmarshallAction_type") :
			getString("_UI_UnmarshallAction_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2Package.Literals.UNMARSHALL_ACTION__OBJECT,
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2Package.Literals.UNMARSHALL_ACTION__RESULT,
