...
/**
 * This is the item provider adapter for a {@link uml2.InteractionUse} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionUseItemProvider extends InteractionFragmentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.INTERACTION_USE__REFERS_TO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.INTERACTION_USE__RETURN_VALUE_RECIPIENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2Package.Literals.INTERACTION_USE__ACTUAL_GATE);
			childrenFeatures.add(Uml2Package.Literals.INTERACTION_USE__ARGUMENT);
			childrenFeatures.add(Uml2Package.Literals.INTERACTION_USE__RETURN_VALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2Package.Literals.INTERACTION_USE__ACTUAL_GATE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == Uml2Package.Literals.INTERACTION_USE__ARGUMENT ||
			childFeature == Uml2Package.Literals.INTERACTION_USE__RETURN_VALUE;
