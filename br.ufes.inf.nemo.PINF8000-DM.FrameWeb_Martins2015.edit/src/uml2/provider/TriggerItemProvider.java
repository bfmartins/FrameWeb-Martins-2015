...
/**
 * This is the item provider adapter for a {@link uml2.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.TRIGGER__EVENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_port_feature", "_UI_Trigger_type"),
				 Uml2Package.Literals.TRIGGER__PORT,
				 true,
				 false,
				 true,
				 null,
