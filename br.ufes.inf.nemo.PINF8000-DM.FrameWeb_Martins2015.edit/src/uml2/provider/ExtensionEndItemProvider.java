...
/**
 * This is the item provider adapter for a {@link uml2.ExtensionEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionEndItemProvider extends PropertyItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtensionEnd"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ExtensionEnd_type") :
			getString("_UI_ExtensionEnd_type") + " " + label;
	}
