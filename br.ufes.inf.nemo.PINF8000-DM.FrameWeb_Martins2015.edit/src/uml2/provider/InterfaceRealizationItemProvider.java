...
/**
 * This is the item provider adapter for a {@link uml2.InterfaceRealization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceRealizationItemProvider extends RealizationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InterfaceRealization_contract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InterfaceRealization_contract_feature", "_UI_InterfaceRealization_type"),
				 Uml2Package.Literals.INTERFACE_REALIZATION__CONTRACT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((InterfaceRealization)object).getName();
