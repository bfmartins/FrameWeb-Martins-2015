...
/**
 * This is the item provider adapter for a {@link uml2.StartObjectBehaviorAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartObjectBehaviorActionItemProvider extends CallActionItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2Package.Literals.START_OBJECT_BEHAVIOR_ACTION__OBJECT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StartObjectBehaviorAction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_StartObjectBehaviorAction_type") :
			getString("_UI_StartObjectBehaviorAction_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2Package.Literals.START_OBJECT_BEHAVIOR_ACTION__OBJECT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == Uml2Package.Literals.START_OBJECT_BEHAVIOR_ACTION__OBJECT;
