...
/**
 * This is the item provider adapter for a {@link uml2.MessageOccurrenceSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageOccurrenceSpecificationItemProvider extends OccurrenceSpecificationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2Package.Literals.MESSAGE_END__MESSAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((MessageOccurrenceSpecification)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MessageOccurrenceSpecification_type") :
			getString("_UI_MessageOccurrenceSpecification_type") + " " + label;
	}
