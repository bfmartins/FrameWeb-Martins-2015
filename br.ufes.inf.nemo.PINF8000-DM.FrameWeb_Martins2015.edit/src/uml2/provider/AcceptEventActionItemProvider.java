...
/**
 * This is the item provider adapter for a {@link uml2.AcceptEventAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AcceptEventActionItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AcceptEventAction_isUnmarshall_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AcceptEventAction_isUnmarshall_feature", "_UI_AcceptEventAction_type"),
				 Uml2Package.Literals.ACCEPT_EVENT_ACTION__IS_UNMARSHALL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2Package.Literals.ACCEPT_EVENT_ACTION__RESULT);
			childrenFeatures.add(Uml2Package.Literals.ACCEPT_EVENT_ACTION__TRIGGER);
		}
