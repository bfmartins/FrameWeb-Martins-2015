...
/**
 * This is the item provider adapter for a {@link ecore.ETypeParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ETypeParameterItemProvider extends ENamedElementItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ETypeParameter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ETypeParameter_type") :
			getString("_UI_ETypeParameter_type") + " " + label;
	}
