...
/**
 * This is the item provider adapter for a {@link ecore.EEnum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EEnumItemProvider extends EDataTypeItemProvider {
	...
	public String getText(Object object) {
		String label = ((EEnum)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EEnum_type") :
			getString("_UI_EEnum_type") + " " + label;
	}
