...
/**
 * This is the item provider adapter for a {@link uml.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_contract_feature", "_UI_Connector_type"),
				 UmlPackage.Literals.CONNECTOR__CONTRACT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_kind_feature", "_UI_Connector_type"),
				 UmlPackage.Literals.CONNECTOR__KIND,
				 false,
				 false,
				 false,
	...
	protected void addRedefinedConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_redefinedConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_redefinedConnector_feature", "_UI_Connector_type"),
				 UmlPackage.Literals.CONNECTOR__REDEFINED_CONNECTOR,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UmlPackage.Literals.CONNECTOR__TYPE,
				 true,
				 false,
				 true,
				 null,
