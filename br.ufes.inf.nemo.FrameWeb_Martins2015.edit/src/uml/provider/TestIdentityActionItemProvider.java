...
/**
 * This is the item provider adapter for a {@link uml.TestIdentityAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestIdentityActionItemProvider extends ActionItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.Literals.TEST_IDENTITY_ACTION__FIRST);
			childrenFeatures.add(UmlPackage.Literals.TEST_IDENTITY_ACTION__RESULT);
			childrenFeatures.add(UmlPackage.Literals.TEST_IDENTITY_ACTION__SECOND);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TestIdentityAction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TestIdentityAction_type") :
			getString("_UI_TestIdentityAction_type") + " " + label;
	}
