...
/**
 * This is the item provider adapter for a {@link uml.AddVariableValueAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddVariableValueActionItemProvider extends WriteVariableActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AddVariableValueAction_isReplaceAll_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AddVariableValueAction_isReplaceAll_feature", "_UI_AddVariableValueAction_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.Literals.ADD_VARIABLE_VALUE_ACTION__INSERT_AT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AddVariableValueAction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AddVariableValueAction_type") :
			getString("_UI_AddVariableValueAction_type") + " " + label;
	}
