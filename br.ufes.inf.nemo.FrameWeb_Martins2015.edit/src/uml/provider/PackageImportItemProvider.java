...
/**
 * This is the item provider adapter for a {@link uml.PackageImport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageImportItemProvider extends DirectedRelationshipItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UmlPackage.Literals.PACKAGE_IMPORT__VISIBILITY,
				 true,
				 false,
				 false,
