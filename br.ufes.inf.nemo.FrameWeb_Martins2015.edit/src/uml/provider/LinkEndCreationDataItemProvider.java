...
/**
 * This is the item provider adapter for a {@link uml.LinkEndCreationData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkEndCreationDataItemProvider extends LinkEndDataItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UmlPackage.Literals.LINK_END_CREATION_DATA__INSERT_AT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_LinkEndCreationData_type") + " " + linkEndCreationData.isIsReplaceAll();
	}
