...
/**
 * This is the item provider adapter for a {@link uml.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_content_feature", "_UI_Image_type"),
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_location_feature", "_UI_Image_type"),
