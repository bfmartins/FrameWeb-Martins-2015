...
/**
 * This is the item provider adapter for a {@link frameweb.TagProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagPropertyItemProvider extends PropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TagPropertyItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TagProperty"));
	}
	...
	public String getText(Object object) {
		String label = ((TagProperty)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TagProperty_type") :
			getString("_UI_TagProperty_type") + " " + label;
	}
