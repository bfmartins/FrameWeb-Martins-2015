...
/**
 * This is the item provider adapter for a {@link frameweb.Vocabulary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VocabularyItemProvider extends PackageItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vocabulary_vocabularyIRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vocabulary_vocabularyIRI_feature", "_UI_Vocabulary_type"),
				 FramewebPackage.Literals.VOCABULARY__VOCABULARY_IRI,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVocabularyDocumentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vocabulary_vocabularyDocument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vocabulary_vocabularyDocument_feature", "_UI_Vocabulary_type"),
				 FramewebPackage.Literals.VOCABULARY__VOCABULARY_DOCUMENT,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FramewebPackage.Literals.VOCABULARY__DIRECTLY_IMPORTS_DOCUMENTS,
				 FramewebFactory.eINSTANCE.createIRI()));

		newChildDescriptors.add
			(createChildParameter
				(FramewebPackage.Literals.VOCABULARY__AXIOMS,
				 FramewebFactory.eINSTANCE.createAxiom()));

		newChildDescriptors.add
			(createChildParameter
				(FramewebPackage.Literals.VOCABULARY__ANNOTATIONS,
				 FramewebFactory.eINSTANCE.createAnnotation()));
	}
