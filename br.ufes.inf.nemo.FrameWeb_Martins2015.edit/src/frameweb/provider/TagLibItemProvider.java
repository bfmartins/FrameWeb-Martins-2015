...
/**
 * This is the item provider adapter for a {@link frameweb.TagLib} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagLibItemProvider extends PackageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TagLibItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TagLib_prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TagLib_prefix_feature", "_UI_TagLib_type"),
				 FramewebPackage.Literals.TAG_LIB__PREFIX,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FramewebPackage.Literals.TAG_LIB__TAG_LIB_TAG);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TagLib"));
	}
	...
	public String getText(Object object) {
		String label = ((TagLib)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TagLib_type") :
			getString("_UI_TagLib_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TagLib.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FramewebPackage.Literals.TAG_LIB__TAG_LIB_TAG,
				 FramewebFactory.eINSTANCE.createTag()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == FramewebPackage.Literals.TAG_LIB__TAG_LIB_TAG;
