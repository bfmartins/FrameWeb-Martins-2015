...
/**
 * This is the item provider adapter for a {@link frameweb.NavigationProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NavigationPropertyItemProvider extends PropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public NavigationPropertyItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((NavigationProperty)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NavigationProperty_type") :
			getString("_UI_NavigationProperty_type") + " " + label;
	}
