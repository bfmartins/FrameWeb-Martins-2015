...
/**
 * This is the item provider adapter for a {@link frameweb.MappingSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingSetItemProvider extends PackageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MappingSetItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MappingSet"));
	}
	...
	public String getText(Object object) {
		String label = ((MappingSet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MappingSet_type") :
			getString("_UI_MappingSet_type") + " " + label;
	}
