...
/**
 * This is the item provider adapter for a {@link frameweb.EntityClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityClassItemProvider extends ClassItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntityClass_table_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntityClass_table_feature", "_UI_EntityClass_type"),
				 FramewebPackage.Literals.ENTITY_CLASS__TABLE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntityClass.class)) {
			case FramewebPackage.ENTITY_CLASS__TABLE:
