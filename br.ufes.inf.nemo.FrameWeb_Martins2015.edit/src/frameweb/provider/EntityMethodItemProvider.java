...
/**
 * This is the item provider adapter for a {@link frameweb.EntityMethod} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityMethodItemProvider extends OperationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EntityMethodItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EntityMethod"));
	}
	...
	public String getText(Object object) {
		String label = ((EntityMethod)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EntityMethod_type") :
			getString("_UI_EntityMethod_type") + " " + label;
	}
