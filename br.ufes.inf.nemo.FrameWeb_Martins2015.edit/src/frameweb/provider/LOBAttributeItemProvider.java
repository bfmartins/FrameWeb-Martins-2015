...
/**
 * This is the item provider adapter for a {@link frameweb.LOBAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LOBAttributeItemProvider extends DomainAttributeItemProvider {
	 ...
	 * @generated
	 */
	public LOBAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LOBAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((LOBAttribute)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LOBAttribute_type") :
			getString("_UI_LOBAttribute_type") + " " + label;
	}
